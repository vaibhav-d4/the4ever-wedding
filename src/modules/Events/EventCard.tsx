        ...
        <div ref={ref}>
          ...
          >
            ...
            <Box className='m-4 tracking-wide flex flex-col gap-2'>
              <Box className='font-semibold text-3xl mb-1 font-alice-regular text-black/80'>
                {name}
              </Box>
        ...
        <div className={clsx('flex flex-col md:flex-row gap-8 w-full')}>
          ...
          <div className='w-full md:w-1/2 flex justify-center items-center mb-4 md:mb-0'>
            <img
              src={eventImage}
              alt={name}
              className='rounded-2xl h-[200px] md:h-[300px] w-full'
              loading='lazy'
            />
          </div>
          ...
          <div className='flex flex-col items-start w-full md:w-1/2'>
            <div className='text-center  w-full'>
              <div className='font-semibold text-2xl mb-2 font-alice-regular text-black/90 md:text-left'>
                {name}
              </div>
              <div className='font-great-vibes text-xl text-primary tracking-wider mb-3 md:text-left'>
                "{quote}"
              </div>
            </div>
            <div>
