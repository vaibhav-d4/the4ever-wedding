...
import image5 from "../assets/couple/image-1.jpg"; // Use image-1 again for demo, replace with your own
...
const GridSideImage = ({
  ...
  >
    <img src={imgSrc} alt="Moment 1" className="object-cover w-full h-full" />
  </div>
);
...
const GridCenterImage = ({
  ...
  >
    <img src={imgSrc} className="object-cover w-full h-72" />
  </div>
);
